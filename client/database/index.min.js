import{downloadQuestionsAsText,downloadBonusesAsCSV,downloadTossupsAsCSV,downloadQuestionsAsJSON}from"./download.js";import{highlightBonusQuery,highlightTossupQuery}from"./highlight-query.js";import star from"../scripts/auth/star.js";import TossupCard from"./TossupCard.min.js";import BonusCard from"./BonusCard.min.js";import CategoryModal from"../scripts/components/CategoryModal.min.js";import DifficultyDropdown from"../scripts/components/DifficultyDropdown.min.js";import Star from"../scripts/components/Star.min.js";import{getDropdownValues,setDropdownValues}from"../scripts/utilities/dropdown-checklist.js";import filterParams from"../scripts/utilities/filter-params.js";import CategoryManager from"../../quizbowl/category-manager.js";import reportQuestion from"../scripts/api/report-question.js";import getSetList from"../scripts/api/get-set-list.js";const starredTossupIds=new Set(await star.getStarredTossupIds()),starredBonusIds=new Set(await star.getStarredBonusIds()),fontSize="true"===window.localStorage.getItem("database-font-size")?window.localStorage.getItem("font-size")??16:16,paginationShiftLength=992<window.screen.width?10:5,categoryManager=new CategoryManager;function arrayBetween(a,b){return Array(b-a).fill().map((b,c)=>a+c)}function QueryForm(){function a(){return Math.floor(1e4/(u||25))}/**
   *
...
:/*#__PURE__*/React.createElement("div",{className:"text-muted"},"No bonuses found"),/*#__PURE__*/React.createElement("div",null,ja),1<aa&&/*#__PURE__*/React.createElement("nav",{"aria-label":"bonus nagivation"},/*#__PURE__*/React.createElement("ul",{className:"pagination justify-content-center"},/*#__PURE__*/React.createElement("li",{className:"page-item"},/*#__PURE__*/React.createElement("a",{className:"page-link",href:"#","aria-label":"First",onClick:a=>{d(a,"first")}},"\xAB")),/*#__PURE__*/React.createElement("li",{className:"page-item"},/*#__PURE__*/React.createElement("a",{className:"page-link",href:"#","aria-label":"Previous",onClick:a=>{d(a,"previous")}},"\u2039")),arrayBetween(Math.min(ea),Math.min(ea+paginationShiftLength,aa)).map(a=>{const b=Y===a+1;return/*#__PURE__*/React.createElement("li",{key:`bonus-pagination-${a+1}`,className:"page-item"},/*#__PURE__*/React.createElement("a",{className:`page-link ${b&&"active"}`,href:"#",onClick:b=>{d(b,a+1)}},a+1))}),/*#__PURE__*/React.createElement("li",{className:"page-item"},/*#__PURE__*/React.createElement("a",{className:"page-link",href:"#","aria-label":"Next",onClick:a=>{d(a,"next")}},"\u203A")),/*#__PURE__*/React.createElement("li",{className:"page-item"},/*#__PURE__*/React.createElement("a",{className:"page-link",href:"#","aria-label":"Last",onClick:a=>{d(a,"last")}},/*#__PURE__*/React.createElement("span",{"aria-hidden":"true"},"\xBB"))))),/*#__PURE__*/React.createElement("div",{className:"mb-5"}))}const root=ReactDOM.createRoot(document.getElementById("root"));root.render(/*#__PURE__*/React.createElement(QueryForm,null)),document.getElementById("report-question-submit").addEventListener("click",function(){reportQuestion(document.getElementById("report-question-id").value,document.getElementById("report-question-reason").value,document.getElementById("report-question-description").value)});